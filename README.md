...
This faucet is a web application with the goal of distributing small amounts of DANK in private and test networks.

## Features

* Allow to configure the funding account via private key or keystore
* Asynchronous processing Txs to achieve parallel execution of user requests
* Rate limiting by DANK address and IP address as a precaution against spam
...
```bash
git clone https://github.com/dankChain/dank-faucet.git
cd dank-faucet
```

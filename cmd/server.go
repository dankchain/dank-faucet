...
import (
	...
	"github.com/dankChain/dank-faucet/internal/chain"
	"github.com/dankChain/dank-faucet/internal/server"
)

var (
	appVersion = "v1.1.0"
	chainIDMap = map[string]int{"dankChain": 6969, "ropsten": 3, "rinkeby": 4, "goerli": 5, "kovan": 42}
